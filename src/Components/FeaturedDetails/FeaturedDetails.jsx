		...
		<div className="flex flex-col px-6 py-8 space-y-6 rounded-sm sm:p-8 lg:p-12 lg:w-1/2 xl:w-2/5 dark:bg-violet-600 dark:text-gray-50">
			...
			<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="flex-shrink-0 w-6 h-6">
				...
				<div className="space-y-2">
					<p className="text-lg font-medium leading-snug">Job Description:</p>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="flex-shrink-0 w-6 h-6">
				...
				<div className="space-y-2">
					<p className="text-lg font-medium leading-snug">Job Responsibility:</p>
			...
			<div className="flex space-x-2 sm:space-x-4">
				...
				<div className="space-y-2">
					<p className="text-lg font-medium leading-snug">Educational Requirements:</p>
